...
// KeyCoin: total coins staked (non-spendable until maturity)
...
// KeyCoin: check 'spent' consistency between wallet and txindex
// KeyCoin: fix wallet spent state according to txindex
...
// KeyCoin: disable transaction (only for coinstake)
